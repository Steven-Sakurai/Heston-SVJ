...
HestonCallMonteCarlo <- function(lambda, vbar, eta, rho, v0, r, tau, S0, K, nSteps=2000, nPaths=3000, vneg=2) {
        ...
        return(list(value=AV, lower = AV-AVdev, upper = AV+AVdev, zerohits = negCount))
}
...
```
```{r}
HestonCallClosedForm(lambda=6.21, vbar=0.019, eta=0.61, rho=-0.7, v0=0.010201,
                     r=0.0319, tau=1.0, S0=100, K=100)
```
```{r}
 HestonCallMonteCarlo(lambda=6.21, vbar=0.019, eta=0.61, rho=-0.7, v0=0.010201,
                      r=0.0319, tau=1.0, S0=100, K=100, nSteps=2000, nPaths=3000, vneg=0)
 HestonCallMonteCarlo(lambda=6.21, vbar=0.019, eta=0.61, rho=-0.7, v0=0.010201,
                      r=0.0319, tau=1.0, S0=100, K=100, nSteps=2000, nPaths=3000, vneg=1)
  HestonCallMonteCarlo(lambda=6.21, vbar=0.019, eta=0.61, rho=-0.7, v0=0.010201,
                       r=0.0319, tau=1.0, S0=100, K=100, nSteps=2000, nPaths=3000, vneg=2)
```
